...
def test_get_keys_from_strings_file(input_file_and_output_file):
    input_file_path, output_file_path = input_file_and_output_file
    keys = converter.get_keys_from_strings_file(input_file_path)
    assert len(keys) == 1

def test_write_keys_to_swift_file(input_file_and_output_file):
    input_file_path, output_file_path = input_file_and_output_file
    converter.write_keys_to_swift_file(['test'], output_file_path)

    assert os.path.exists(output_file_path) == True
